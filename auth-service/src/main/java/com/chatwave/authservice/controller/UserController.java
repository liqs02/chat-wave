...
public class UserController {
    ...
    public void patchUserPassword(@PathVariable Integer id, @Valid @RequestBody ChangePasswordRequest changePasswordRequest) {
        var user = mapper.toUser(id, changePasswordRequest);
